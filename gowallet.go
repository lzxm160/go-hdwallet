...
#cgo  LDFLAGS:  -L /root/bip44cxx  -L /root/bitcoin-0.15.1/src -lbip44wallet -lbitcoin -lbitcoin-client -lbitcoin_server -lbitcoin_util -lbitcoin_consensus -lbitcoin_common -lbitcoin_cli
#include <stdlib.h>
#include "interface.h" 
